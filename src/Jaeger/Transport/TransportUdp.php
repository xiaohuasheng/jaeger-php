...
class TransportUdp implements Transport{
    ...
    public function buildAndCalcSizeOfProcessThrift(Jaeger $jaeger){
        $jaegerThriftSpan = new JaegerThriftSpan();
        $jaeger->processThrift = $jaegerThriftSpan->buildJaegerProcessThrift($jaeger);
    ...
    public function append(Jaeger $jaeger){
        ...
        foreach($jaeger->spans as $span){
            ...
            $jaegerThriftSpan = new JaegerThriftSpan();
            $spanThrift = $jaegerThriftSpan->buildJaegerSpanThrift($span);
            ...
            if($this->bufferSize > self::$maxSpanBytes){
                ...
                self::$batchs[] = array('thriftProcess' => $jaeger->processThrift
